...
describe Register::CharactersController do
  ...
  # Register::Character. As you add validations to Register::Character, be sure to
  ...
  # Register::CharactersController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all register_characters as @register_characters" do
      character = Register::Character.create! valid_attributes
      get :index, {}, valid_session
      assigns(:register_characters).should eq([character])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new character as @character" do
      ...
      assigns(:character).should be_a_new(Register::Character)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved character as @character" do
        ...
        Register::Character.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested character" do
        character = Register::Character.create! valid_attributes
        # Assuming there are no other register_characters in the database, this
        # specifies that the Register::Character created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Register::Character.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the register_characters list" do
      character = Register::Character.create! valid_attributes
      delete :destroy, {:id => character.to_param}, valid_session
      response.should redirect_to(register_characters_url)
    end
  end

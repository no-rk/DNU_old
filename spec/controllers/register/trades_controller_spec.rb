...
describe Register::TradesController do
  ...
  # Register::Trade. As you add validations to Register::Trade, be sure to
  ...
  # Register::TradesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all register_trades as @register_trades" do
      trade = Register::Trade.create! valid_attributes
      get :index, {}, valid_session
      assigns(:register_trades).should eq([trade])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new trade as @trade" do
      ...
      assigns(:trade).should be_a_new(Register::Trade)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trade as @trade" do
        ...
        Register::Trade.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trade" do
        trade = Register::Trade.create! valid_attributes
        # Assuming there are no other register_trades in the database, this
        # specifies that the Register::Trade created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Register::Trade.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the register_trades list" do
      trade = Register::Trade.create! valid_attributes
      delete :destroy, {:id => trade.to_param}, valid_session
      response.should redirect_to(register_trades_url)
    end
  end

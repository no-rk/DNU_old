          ...
          if user.register(:main).present?
            user.register(:main).trains.includes(:train).each do |train|
              ...
              when :status
                ...
                result_train.success   = result_status.grow_using_point_name!(:NP)
              ...
              when :art
                ...
                result_train.success   = result_art.grow_using_point_name!(:GP)
              ...
              when :product
                ...
                result_train.success   = result_product.grow_using_point_name!(:SP)
              ...
              when :ability
                ...
                result_train.success   = result_ability.grow_using_point_name!(:AP)

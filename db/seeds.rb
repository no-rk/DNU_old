...
# 戦闘値, 属性, アイテム種類, 装備種, キャラクター種類, 地形, ポイント, 戦闘設定, 技能種類, 技能
[:battle_value, :element, :item_type, :equip_type, :character_type, :landform, :point, :battle_setting, :art_type, :art].each do |table|

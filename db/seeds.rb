...
# 戦闘値, 属性, アイテム種類, 装備種, 地形, 戦闘設定, 技能種類, 技能, 守護, ポイント, ポイント使用
[:battle_value, :element, :item_type, :equip_type, :landform, :battle_setting, :art_type, :art, :guardian, :point, :point_use].each do |table|

class Register::Main < ActiveRecord::Base
  ...
  has_many :item_uses,    :order => "id ASC", :dependent => :destroy
  ...
  accepts_nested_attributes_for :item_uses,    :reject_if => :all_blank
  ...
  attr_accessible :diary_attributes, :shouts_attributes, :disposes_attributes, :item_uses_attributes, :moves_attributes, :forgets_attributes, :blossoms_attributes, :trains_attributes, :party_slogan_attributes

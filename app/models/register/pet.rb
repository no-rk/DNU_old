class Register::Pet < ActiveRecord::Base
  ...
  attr_accessible :pet_id, :profile_attributes, :battle_settings_attributes, :serif_settings_attributes
  ...
  def build_pet
    ...
    (2-self.serif_settings.size).times{self.serif_settings.build}
  end

...
multicols_2 = bra multi [2２] ket newline? inner:(align align)       { return '<div class="multicols_2">' + peg_flatten(inner).join('') + '</div>' + "\n"; }
multicols_3 = bra multi [3３]? ket newline? inner:(align align align) { return '<div class="multicols_3">' + peg_flatten(inner).join('') + '</div>' + "\n"; }
...
icon_l  = bra '左'? num:num ket   { return ['l', num]; }
icon_r  = bra '右'  num:num ket   { return ['r', num]; }
...
tags    = self / target / newline / bold / italic / delete / under / big / small / ruby / font_color / thin_tag / middle_tag / font_color0_tag / normal_tag
self    = bra '自分' ket { return '「自分の愛称」'; }
target  = bra '対象' ket { return '「対象の愛称」'; }
newline = [\n\r] { return '<br>'; }
bold   =   bold_tag inner:(!(text_tags / normal_tag /   thin_tag) (tags / any))+ &(  thin_tag / normal_tag)? { return '<b>'     + peg_flatten(inner).join('') +     '</b>'; }
...
big    =    big_tag inner:(!(text_tags / normal_tag / middle_tag) (tags / any))+ &(middle_tag / normal_tag)? { return '<big>'   + peg_flatten(inner).join('') +   '</big>'; }
small  =  small_tag inner:(!(text_tags / normal_tag / middle_tag) (tags / any))+ &(middle_tag / normal_tag)? { return '<small>' + peg_flatten(inner).join('') + '</small>'; }
...
font_color1 = font_color1_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color1_tag? &(font_color0_tag / normal_tag)? { return '<font color="#FF0000">' + peg_flatten(inner).join('') + '</font>'; }
font_color2 = font_color2_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color2_tag? &(font_color0_tag / normal_tag)? { return '<font color="#FFA500">' + peg_flatten(inner).join('') + '</font>'; }
font_color3 = font_color3_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color3_tag? &(font_color0_tag / normal_tag)? { return '<font color="#FFFF00">' + peg_flatten(inner).join('') + '</font>'; }
font_color4 = font_color4_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color4_tag? &(font_color0_tag / normal_tag)? { return '<font color="#00FF00">' + peg_flatten(inner).join('') + '</font>'; }
font_color5 = font_color5_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color5_tag? &(font_color0_tag / normal_tag)? { return '<font color="#0000FF">' + peg_flatten(inner).join('') + '</font>'; }
font_color6 = font_color6_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color6_tag? &(font_color0_tag / normal_tag)? { return '<font color="#000080">' + peg_flatten(inner).join('') + '</font>'; }
font_color7 = font_color7_tag inner:(!(text_tags / normal_tag / font_color_tag) (tags / any))+ font_color7_tag? &(font_color0_tag / normal_tag)? { return '<font color="#800080">' + peg_flatten(inner).join('') + '</font>'; }

  bold_tag = bra b ket
  thin_tag = bra t ket { return ''; }
italic_tag = bra i ket
delete_tag = bra d ket
 under_tag = bra u ket
 small_tag = bra s ket
middle_tag = bra m ket { return ''; }
   big_tag = bra bg ket

font_color_tag = font_color0_tag / font_color1_tag / font_color2_tag / font_color3_tag / font_color4_tag / font_color5_tag / font_color6_tag / font_color7_tag
font_color0_tag = bra '黒' ket { return ''; }

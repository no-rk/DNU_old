    ...
    parse: function(input, startRule) {
      ...
      function parse_tag_plain() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, inner) {
        return (function() {
          return this.return_html('plain', inner.map(function(h, i) {
            return h[1];
          }));
        }).apply(__initializer);
        })(pos0, result0[1]);
